    ...
    return (
        <section className="section-lg min-h-screen">
            <div className="flex flex-col justify-center items-center rounded-xl">
                ...
                <Link to='/' className="bg-[var(--primary)] !px-8 !py-3 text-white font-body hover:bg-[var(--accent)] trasition-all ease-in-out duration-200 rounded-xl flex flex-row items-center gap-2"><FaArrowLeft aria-hidden="true" focusable="false" /> Voltar</Link>
            </div>
        </section>
    )
}
