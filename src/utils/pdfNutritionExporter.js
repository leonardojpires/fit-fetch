...
export default function pdfNutritionExporter(nutritionPlan, user) {
  ...
  function addHeader(withLogo) {
    ...
    doc.text("Plano de Nutrição Personalizado", 105, titleY, { align: "center" });
  ...
  function addNutritionDetailsAndSave() {
    doc.setFontSize(12);
    doc.setTextColor(40, 40, 40);
    let yPosition = addHeader.detailsStartY || 48;
